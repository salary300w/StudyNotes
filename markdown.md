- [[Markdown+Typora/VSCode 超全教程] 给大一新生安利的文本神器](#markdowntyporavscode-超全教程-给大一新生安利的文本神器)
  - [😂 简要介绍](#-简要介绍)
  - [📐 实际应用](#-实际应用)
  - [🍴 工具](#-工具)
    - [Typora](#typora)
    ...
    - [其他](#其他)
  - [🍭 基础教程](#-基础教程)
    - [0. 写 Markdown 的第零步](#0-写-markdown-的第零步)
    - [1. 标题 [数个 "#" + 空格 前置]](#1-标题-数个---空格-前置)
    - [2. 强调 [用 "**" 或 "__" 包围]](#2-强调-用--或-__-包围)
    - [3. 斜体 [用 "*" 或 "_" 包围]](#3-斜体-用--或-_-包围)
  ...
  - [💯 总结](#-总结)# [Markdown+Typora/VSCode 超全教程] 给大一新生安利的文本神器
## 😂 简要介绍
